  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6 md:py-12">
      ...
      <Card className="border-2 border-green-200">
        {/* 타이포그래피: 제목 */}
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6 md:mb-8 text-gray-900">로그인</h1>
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <Link to="/signup" className="text-blue-600 hover:text-blue-700 font-semibold text-base md:text-lg transition-colors">
              회원가입
            </Link>
          </div>
        </form>
